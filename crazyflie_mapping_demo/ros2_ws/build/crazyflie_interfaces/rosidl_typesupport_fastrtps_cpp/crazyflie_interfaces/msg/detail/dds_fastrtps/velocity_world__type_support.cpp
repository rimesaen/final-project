...
#include "crazyflie_interfaces/msg/detail/velocity_world__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces::msg::VelocityWorld;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::VelocityWorld *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crazyflie_interfaces::msg::VelocityWorld *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VelocityWorld__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::VelocityWorld *>(
...
static size_t _VelocityWorld__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_VelocityWorld(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VelocityWorld__callbacks = {
...
static rosidl_message_type_support_t _VelocityWorld__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VelocityWorld__callbacks,
...
{
  return &crazyflie_interfaces::msg::typesupport_fastrtps_cpp::_VelocityWorld__handle;
}
