...
#include "crazyflie_interfaces/msg/detail/connection_statistics_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const crazyflie_interfaces::msg::ConnectionStatistics &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: stats
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        crazyflie_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_ConnectionStatistics(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces::msg::ConnectionStatisticsArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::ConnectionStatisticsArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crazyflie_interfaces::msg::ConnectionStatisticsArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ConnectionStatisticsArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::ConnectionStatisticsArray *>(
...
static size_t _ConnectionStatisticsArray__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ConnectionStatisticsArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ConnectionStatisticsArray__callbacks = {
...
static rosidl_message_type_support_t _ConnectionStatisticsArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ConnectionStatisticsArray__callbacks,
...
{
  return &crazyflie_interfaces::msg::typesupport_fastrtps_cpp::_ConnectionStatisticsArray__handle;
}
