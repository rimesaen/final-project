...
#include "crazyflie_interfaces/msg/detail/status__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = crazyflie_interfaces::msg::Status;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const crazyflie_interfaces::msg::Status *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<crazyflie_interfaces::msg::Status *>(
    untyped_ros_message);
...
get_message_type_support_handle<crazyflie_interfaces::msg::Status>()
{
  return &crazyflie_interfaces::msg::typesupport_fastrtps_cpp::_Status__handle;
}
